 ...
 */
function formatWhatsAppCurrency(value: string | number | null): string {
 ...
 */
export async function getUserPhoneNumberFromClerk(clerkId: string): Promise<string | null> {
  if (!clerk) {
 ...
 */
export async function sendWhatsAppAlert(payload: WhatsAppPayload): Promise<{ success: boolean; externalId?: string; error?: string }> {
